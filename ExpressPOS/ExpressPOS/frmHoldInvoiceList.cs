...
{
    public partial class frmHoldInvoiceList : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            string sqlStr = " SELECT INVOICE_NO, Sales_Date, PaymentMethod, Comment   FROM    Sale " +
                            " WHERE        (Status = 'H') AND (Sales_Date = '" + dtpFrom.Value.Date.ToString("MM/dd/yyyy") + "') ";
        ...
        private void frmHoldInvoiceList_Load(object sender, EventArgs e)
        {
        ...
        private void ProductDataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 0)
            {
                ...
                {
                    GlobalVariables.TEMP_INVOICE_NO = ProductDataGridView.CurrentRow.Cells[2].Value.ToString();
                    this.Close();
                }
            }
        ...
        private void frmHoldInvoiceList_FormClosed(object sender, FormClosedEventArgs e)
        {
            Invoice_No = GlobalVariables.TEMP_INVOICE_NO;
        }
    }
}
